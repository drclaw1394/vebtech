...
if exists("javaScript_fold")
 ...
 syn match	javaScriptClass		"\<class\>"
 syn region	javaScriptClassFold	start="\<class\>.*[^};]$" end="^}.*$" transparent fold keepend
 syn sync match javaScriptSync	grouphere javaScriptClassFold "\<class\>"
 syn sync match javaScriptSync	grouphere NONE "^}"
...
hi def link javaScriptClass		Function
